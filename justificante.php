...
?>
 <title>Formatos | Justificante</title> <!-- AQUÍ SE CAMBIA EL TITULO QUE APARECE EN LA PESTAÑA DEL NAVEGADOR -->
                          ...
                          <?php
                                ...
                                while($data = mysqli_fetch_array($result)) {                  
                                  ...
                                  echo "  <td>".$data['fecha']."</td>
                                          ...
                                          <button type='button' class='btn btn-danger borrar admin' id=".$data['id_justificante']."><i class='far fa-trash-alt'></i></button></td>";
                                  echo "</tr>";
                                }
                          ?>
                      </tbody>
                      ...
                      <div class="modal fade bs-example-modal-lg" id="modalwindow" tabindex="-1" role="dialog" aria-hidden="true">
                          ...
                          <div class="modal-content">
                              ...
                              <div class="modal-header">
                                  ...
                                  <h4 class="modal-title" id="myModalLabel">Registrar nuevo justificante</h4>
                              </div>
                            <div class="modal-body">
                                <form id="justificante" data-parsley-validate="" method="post" action="cont/AddJustificante.php" class="form-horizontal form-label-left">
                                  ...
                                  <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="dias-just">Días a justificar<span class="required">*</span>
                                    </label>
                                    <div class="col-md-3 col-sm-3 col-xs-6">
                                      <input type="number" id="dias-just" name="dias-just" required="required" class="form-control col-md-7 col-xs-12">
                                    </div>
                                  </div>
                                  ...
                                  <hr>
                                  <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="motivo_bitacora">Motivo (para registrar en bitacora) <span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                    <textarea class="resizable_textarea form-control" id="motivo_bitacora" name="motivo_bitacora"></textarea>
                                    </div>
                                  </div>
...
<script src="build/js/justificante.js"></script>

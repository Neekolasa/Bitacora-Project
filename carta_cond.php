...
?>
  ...
  <title>Formatos | Carta de condicionamiento</title> <!-- AQUÍ SE CAMBIA EL TITULO QUE APARECE EN LA PESTAÑA DEL NAVEGADOR -->
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Carta de Condicionamiento</h2>
                    <div class="clearfix"></div>
                    <nav aria-label="breadcrumb" id="bread">
                      <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="inicio.php">Inicio</a></li>
                        <li class="breadcrumb-item"><a href="#">Formatos</a></li>
                        <li class="breadcrumb-item active">Carta de condicionamiento</li>
                      </ol>
                    </nav>
                  </div>
                  <div class="x_content">
                          ...
                          <?php
                                ...
                                while($data = mysqli_fetch_array($result)) {
                                    ...
                                    echo "  <td>".$data['fecha']."</td>
                                            ...
                                            <button type='button' class='btn btn-danger borrar admin' id=".$data['id_carta_cond']."><i class='far fa-trash-alt'></i></button></td>";
                                    echo "</tr>";
                                }
                          ?>
                      </tbody>
                      ...
                      <div class="modal fade bs-example-modal-lg" id="modalwindow" tabindex="-1" role="dialog" aria-hidden="true">
                          ...
                          <div class="modal-content">
                              ...
                              <div class="modal-header">
                                  ...
                                  <h4 class="modal-title" id="myModalLabel">Registrar nueva carta de condicionamiento</h4>
                              </div>
                            <div class="modal-body">
                                <form id="carta-cond" data-parsley-validate="" autocomplete="off" class="form-horizontal form-label-left" method="post" action="cont/AddCartaCond.php" >
                                  ...
                                  <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="retribucion">Retribución <span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                      <input type="text" id="retribucion" name="retribucion" required="required" class="form-control col-md-7 col-xs-12">
                                    </div>
                                  </div>
...
<script src="build/js/carta_cond.js"></script>
